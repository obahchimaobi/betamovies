        ...
        <div class="w-full lg:ps-64">
            <div class="p-4 sm:p-6 space-y-4 sm:space-y-6 my-10">
                ...
                <div class="flex items-center justify-between">
                    <h1 class="text-gray-800 dark:text-white lg:text-3xl text-2xl font-semibold font-roboto">Top Rated</h1>
                ...
                <div class="grid xl:grid-cols-6 grid-cols-2 gap-4">
                    <div class="w-full">
                        <a href="" wire:navigate><img
                                src="https://nkiri.com/wp-content/uploads/2024/11/the-day-of-the-jackal-tv-series-200x300.jpg"
                                alt=""

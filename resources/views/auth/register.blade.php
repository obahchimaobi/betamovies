...
@section('content')
    ...
    <div class="w-full lg:ps-64">
        <div class="p-4 sm:p-6 space-y-4 sm:space-y-6">
            ...
            {{-- Display this if user is already logged in --}}
            @auth
    ...
    <div id="hs-danger-alert"
        class="hs-overlay hidden size-96 mx-auto fixed inset-0 z-[80] overflow-x-hidden overflow-y-auto items-center justify-center" role="dialog"

            ...
            <nav class="hs-accordion-group p-3 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
                <ul class="flex flex-col space-y-1">
                    ...
                    <li class="hs-accordion" id="users-accordion">
                        <button type="button"
                            class="hs-accordion-toggle w-full text-start flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-none dark:hover:bg-slate-700 dark:text-neutral-200 focus:bg-slate-600"
                                ...
                                <li class="hs-accordion" id="users-accordion-sub-1">
                                    ...
                                    <div id="users-accordion-sub-1-child"
                                        ...
                                        <ul class="pt-1 ps-8 space-y-1">
                                            <li>
                                                <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-800 rounded-lg hover:bg-slate-700 focus:outline-none dark:text-neutral-200"
                                                    href="#">
                                                    Action
                                                </a>
                                            </li>

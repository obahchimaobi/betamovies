<div>
    ...
    @if ($isInWatchlist)
        <li
            class="bg-blue-600 text-white px-5 py-3 rounded-full uppercase text-xs font-black hover:cursor-pointer hover:bg-blue-700 duration-200 flex gap-1" wire:click="removeFromWatchlist">

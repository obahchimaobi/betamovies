<div>
    ...
    {{-- <div class="fixed w-auto bg-white shadow-md rounded-lg mt-2 dark:bg-slate-800 dark:border dark:border-slate-700 dark:divide-slate-700"
    ...
    @if (sizeof($results) > 0)
        <div
            class="p-1.5 space-y-0.5 rounded-lg mt-2 bg-white border border-gray-300 dark:bg-slate-800 dark:border dark:border-slate-700 dark:divide-slate-700 fixed flex-col max-w-72 md:flex md:flex-col hidden">

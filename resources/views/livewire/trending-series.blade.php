<div>
    @section('title')
        Download Best Trending Series on {{ config('app.name') }} For Free
    @endsection
    ...
    @section('content')
        <div>
            ...
            <div class="w-full lg:ps-64">
                <div class="p-4 sm:p-6 space-y-4 sm:space-y-6 my-10" id="trending_series">
                    <!-- your content goes here ... -->
                    <div class="flex items-center justify-between">
                        <h1 class="text-black dark:text-white lg:text-3xl text-2xl font-semibold">Trending Series</h1>
                    ...
                    <livewire:media.trending-series lazy />
                </div>
            </div>
            <!-- End Content -->
        </div>

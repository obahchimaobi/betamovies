<div>
    @section('title')
        Download Best Korean Movies For Free | {{ config('app.name') }}
    @endsection

    @section('meta_description')
    Explore k-movies on {{ config('app.name') }}. Download the highest-rated films and add your favorites to your watchlist today.
    @endsection
            ...
            <div class="w-full lg:ps-64">
                <div class="p-4 sm:p-6 space-y-4 sm:space-y-6 my-10" id="korean-drama">
                    ...
                    <div class="flex items-center justify-between">
                        <h1 class="text-black dark:text-white lg:text-3xl text-2xl font-semibold">Korean Movies</h1>
                    ...
                    <livewire:media.korean-movies lazy>
                </div>
            </div>
            <!-- End Content -->
        </div>
